...
const words = ["quiet forests","bottomless diner coffee", "deep still water", "narcolepsy", "extraterrestrial contact", "undersea caverns", "heatstroke", "my childhood home", "New York City",
...
"bone-deep anger", "driving very slowly", "the smell of gasoline", "burnt coffee", "peeping toms", "Marilyn Manson", "sliced lemon", "immense popularity", 
...
"a pernicious virus", "public transit", "trusted maids","cavernous silence", "frantic hand signals", "novice archers", "very strong magnets", "stone castles", "a mistake in the order", "charcoal sketches", 
...
"a familiar threat", "waking in a field, covered with dew", "a meditative trance", "the innacuracies of the Stanford Prison Experiment", "naming an old dog", 
...
"ice water sweating through the glass","an empty wooden bowl", "a jacket that no longer fits", "a clear pool hidden among the rocks", "an arm moving the wrong way", 
